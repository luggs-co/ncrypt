...
server and the integrity of it's operators. With <?=$site_name;?>, you get a <a href="https://en.wikipedia.org/wiki/JavaScript" target="_blank">Javascript file</a> which encrypts your<br />
paste using state of the art <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard" target="_blank">AES-256-OFB cipher</a> before it ever leaves your computer!<br />
...
<br />
<b>A:</b> The key is stored in the <a href="https://en.wikipedia.org/wiki/Fragment_identifier" target="_blank">Anchor Hash</a>, the part after the "#" which is not uploaded to the server but<br />
...
These so-called "<a href="https://en.wikipedia.org/wiki/Man-in-the-middle_attack" target="_blank">Man in The Middle</a>" attacks are much less frequent than passive listening and unlike<br />
